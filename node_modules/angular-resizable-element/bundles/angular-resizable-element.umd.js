(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-resizable-element', ['exports', 'tslib', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global['angular-resizable-element'] = {}),global.tslib,global.ng.core,null,global.Rx.Observable.prototype));
        ...
        ResizableDirective.prototype.ngOnInit = function () {
            ...
            var /** @type {?} */ mousedrag = this.mousedown
                ...
                return rxjs.merge(mouseMove.pipe(operators.take(1)).pipe(operators.map(function (coords) { return [, coords]; })), mouseMove.pipe(operators.pairwise()))
                    ...
                    var _b = tslib.__read(_a, 2), previousCoords = _b[0], newCoords = _b[1];
                    return [
                    ...
                    .pipe(operators.map(function (_a) {
                    var _b = tslib.__read(_a, 2), newCoords = _b[1];
                    var /** @type {?} */ snapGrid = getSnapGrid();
                    return {
